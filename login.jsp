...
<body>
    ...
    <div class="container">
        <h1 style="margin: 2vw 0vw; text-align: center; color: rgb(235, 196, 124);">Log in</h1>
        <form action="loginvalid.jsp" method="post">
            ...
            <input type="submit" value="log in" class="btn btn-primary" style="margin-bottom: 0.5vw; background-color: rgb(235, 196, 124); border: 1px solid  rgb(235, 196, 124);">
        </form>
        <a href="register.jsp" style="text-decoration: none; color:rgb(235, 196, 124) ;">Create an Account</a>
    </div>
</body>
</html>