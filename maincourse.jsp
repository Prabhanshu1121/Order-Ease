...
<body>
    <div class="main">
        <h1 style="text-align: center; font-size: 4vw;">Main Course</h1>
        <hr >
        <div class="second">
        <% 
        try {
...
function passValue(button,productname, price,filename,userid) {
    ...
    window.location.href = "cart.jsp?quantity=" + quantity + "&productname=" + productname + "&price=" + price + "&filename=" + filename+"&category="+"maincourse"+"&userid="+userid;
}
</script>
